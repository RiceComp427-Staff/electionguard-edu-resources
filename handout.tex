...
\item The more effort and storage we dedicate to precomputation, the
  ...
  multiplies. The real ElectionGuard will {\em probably} end up
  doing 10-bit lookups, but it's much easier to implement the code
  with 8-bit lookups because it's easier to convert an element to
  an array of bytes, so that's what we're asking you to do.
