...
\python{\item As you work on {\tt g\_pow\_p} and {\tt pow\_p} in {\tt
      group.py}, you'll most likely want to take advantage of the {\tt
      q\_to\_bytes} function, already present there, to
    extract the bytes that you'll be using.}
\kotlin{\item As you work on {\tt gPowP} and {\tt powP} in {\tt 
